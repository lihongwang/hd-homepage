define([
    ...
    '../../block_manager/index',
    '../../trait_manager/index'
], function(Backbone, UndoManager, key, utils, storage_manager, device_manager,
    parser, selector_manager, modal_dialog, code_manager, panels, rich_text_editor,
    style_manager, asset_manager, css_composer, dom_components,
    canvas, commands, block_manager, trait_manager) {
