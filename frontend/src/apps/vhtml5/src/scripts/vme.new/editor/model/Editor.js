define([
    'exports',
    'underscore',
    'scripts/vme.new/utils/index',
    'scripts/vme.new/utils/extender',
    'scripts/vme.new/keymaps/index',
    'scripts/vme.new/undo_manager/index',
    'scripts/vme.new/storage_manager/index',
    'scripts/vme.new/device_manager/index',
    'scripts/vme.new/parser/index',
    'scripts/vme.new/selector_manager/index',
    'scripts/vme.new/modal_dialog/index',
    'scripts/vme.new/code_manager/index',
    'scripts/vme.new/panels/index',
    'scripts/vme.new/rich_text_editor/index',
    'scripts/vme.new/style_manager/index',
    'scripts/vme.new/asset_manager/index',
    'scripts/vme.new/css_composer/index',
    'scripts/vme.new/trait_manager/index',
    'scripts/vme.new/dom_components/index',
    'scripts/vme.new/canvas/index',
    'scripts/vme.new/commands/index',
    'scripts/vme.new/block_manager/index',
    'scripts/vme.new/tpl_manager/index'
], function(exports, _underscore) {
    'use strict';

    var _extends = Object.assign || function(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
    var deps = [
        require('scripts/vme.new/utils/index'),
        require('scripts/vme.new/keymaps/index'),
        require('scripts/vme.new/undo_manager/index'),
        require('scripts/vme.new/storage_manager/index'),
        require('scripts/vme.new/device_manager/index'),
        require('scripts/vme.new/parser/index'),
        require('scripts/vme.new/selector_manager/index'),
        require('scripts/vme.new/modal_dialog/index'),
        require('scripts/vme.new/code_manager/index'),
        require('scripts/vme.new/panels/index'),
        require('scripts/vme.new/rich_text_editor/index'),
        require('scripts/vme.new/style_manager/index'),
        require('scripts/vme.new/asset_manager/index'),
        require('scripts/vme.new/css_composer/index'),
        require('scripts/vme.new/trait_manager/index'),
        require('scripts/vme.new/dom_components/index'),
        require('scripts/vme.new/canvas/index'),
        require('scripts/vme.new/commands/index'),
        require('scripts/vme.new/block_manager/index'),
        require('scripts/vme.new/tpl_manager/index')
    ]
    var Backbone = require('backbone');
    var timedInterval = undefined;

    require('scripts/vme.new/utils/extender')({
        Backbone: Backbone,
        $: Backbone.$
    });
