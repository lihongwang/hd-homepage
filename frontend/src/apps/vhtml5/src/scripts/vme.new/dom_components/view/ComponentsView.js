define(['exports', 'module', 'underscore'], function(exports, module, underscore, ComponentView) {
    'use strict';
    require(['scripts/vme.new/dom_components/view/ComponentView']);
    module.exports = Backbone.View.extend({
        ...
        addToCollection: function addToCollection(model, fragmentEl, index) {
            if (!this.compView) this.compView = require('scripts/vme.new/dom_components/view/ComponentView');
