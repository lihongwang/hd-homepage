define([
    ...
    "backbone",
    "toastr",
    "scripts/vme.new/index",
    "text!scripts/routes/home/home.html",
    "skylarkBs"
], function(skylarkjs, $, server, partial, List, backbone, toastr, vme, homeTpl) {
    ...
    return spa.RouteController.inherit({
        ...
        preparing: function(e) {
            var self = this;
            e.result = server().connect("photos", "get", "index").then(function(data) {
                self.photos = data.rows;
            });
        },
        ...
        rendered: function(e) {
            var images = this.photos.map(function(p) { return p.src });
            var editor = vme.init({
                height: '100%',
                container: '#gjs',
                fromElement: 1,
